...
import { DeletedVehiclesColumns } from "./ColumnDeletedVehicle";
import TableSkeleton from "../../components/TableSekeleton";
import { forceDeleteVehicle, getSoftDeletedVehicles, restoreVehicle } from "@/lib/controllers/VehicleController";


const TableDeletedVehicle = () => {
  ...
  const { data, isLoading, isError, refetch } = useQuery({
    ...
    queryFn: () => getSoftDeletedVehicles(page, perPage),
  ...
  const handleRestore = async (id: string) => {
    try {
      ...
      await refetch();
      toast.success("Vehicle restore successfully");
    } catch (error) {
      console.log(error);
  ...
  const handleForceDelete = async (id: string) => {
    try {
      await forceDeleteVehicle(id);
      await refetch();
      toast.success("Vehicle force deleted successfully");
    } catch (error) {
      console.log(error);
      toast.error("Failed to delete Vehicle");
    }
  ...
  const columnDefaults = DeletedVehiclesColumns(handleRestore, handleForceDelete);
...
export default TableDeletedVehicle;

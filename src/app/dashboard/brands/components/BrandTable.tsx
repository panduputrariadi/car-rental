...
import TableSkeleton from "../../categories/components/TableSkeleton";
...
const BrandTable = () => {
  ...
  return (
    <div className="p-4 space-y-4 overflow-x-scroll">
      <div className="flex items-center gap-4">
        <Input
          placeholder="Filter brand name..."
          value={(brandTable.getColumn("brand_name")?.getFilterValue() as string) ?? ""}
          onChange={(event) =>
            brandTable.getColumn("brand_name")?.setFilterValue(event.target.value)
          }
          className="max-w-sm"
        />
      ...
      <div className="rounded-md border overflow-x-auto">
        <Table>
          <TableHeader>
            {brandTable.getHeaderGroups().map((headerGroup) => (
